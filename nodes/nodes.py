...
# Ensure skintoken model folder is registered in folder_paths
...
if "skintoken" not in folder_paths.folder_names_and_paths:
...
class SkinTokensModelLoader:
    ...
    def load_model(self, model_name):
        ...
        skintoken_folders = folder_paths.get_folder_paths("skintoken") if hasattr(folder_paths, "get_folder_paths") else []
        skintoken_models_dir = skintoken_folders[0] if skintoken_folders else os.path.join(getattr(folder_paths, "models_dir", ""), "skintoken")
